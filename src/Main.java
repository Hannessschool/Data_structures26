...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Recursy.ops = 0;
        System.out.println(" \n fibonacci: " + Recursy.fib(40));
        System.out.println(Recursy.ops);
        Recursy.ops = 0;

        System.out.println(" \n fast fib: " + Recursy.fastFib(4)); // 1, 1, 2, 3, 5, 8...
        System.out.println(Recursy.ops);
        Recursy.ops = 0;
        System.out.println(" \n fast fib: " + Recursy.fastFib(40));
        System.out.println(Recursy.ops);
        ...
        // Lägg till namnen i hashtabellen;
